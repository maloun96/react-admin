  ...
  render () {
    return (
    	<div>
		    ...
		    <a href="public/index2.html" className="logo">
		      <span className="logo-mini"><b>A</b>LT</span>
		      <span className="logo-lg"><b>Admin</b>LTE</span>
		    </a>
		    <nav className="navbar navbar-static-top">
		      <a href="public/#" className="sidebar-toggle" data-toggle="offcanvas" role="button">
		      ...
		      <div className="navbar-custom-menu">
		        <ul className="nav navbar-nav">
		          <li className="dropdown messages-menu">
		            <a href="public/#" className="dropdown-toggle" data-toggle="dropdown">
		            ...
		            <ul className="dropdown-menu">
		              ...
		              <li className="footer"><a href="public/#">See All Messages</a></li>
		            </ul>
		          </li>
		          <li className="dropdown notifications-menu">
		            ...
		            <ul className="dropdown-menu">
		              ...
		              <li className="footer"><a href="public/#">View all</a></li>
		            </ul>
		          </li>
		          ...
		          <li className="dropdown user user-menu">
		            ...
		            <ul className="dropdown-menu">
		              ...
		              <li className="user-footer">
		                <div className="pull-left">
		                  <a href="public/#" className="btn btn-default btn-flat">Profile</a>
		                </div>
		                <div className="pull-right">
		                  <a href="public/#" className="btn btn-default btn-flat">Sign out</a>
		                </div>
		              </li>
		            </ul>
		          </li>
		          <li>
		            <a href="public/#" data-toggle="control-sidebar"><i className="fa fa-gears"></i></a>
		          </li>
		        </ul>
		      </div>
		    </nav>
