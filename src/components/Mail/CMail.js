                        ...
                        <div className="col-md-9">
                            <div className="box box-primary">
                                ...
                                <div className="box-body">
                                    ...
                                    <div className="form-group">
                                    <textarea id="compose-textarea" defaultValue={text} className="form-control">
                                ...
                                <div className="box-footer">
                                    <div className="pull-right">
                                        <button type="button" className="btn btn-default"><i className="fa fa-pencil"></i> Draft
                                        </button>
                                        <button type="submit" className="btn btn-primary"><i className="fa fa-envelope-o"></i>
                                            Send
                                        </button>
                                    </div>
